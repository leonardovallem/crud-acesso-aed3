...
public class AllPerguntasController {
        ...
        while (option != 0) {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    while (page != 0) {
                        System.out.println("Perguntas mais recentes - página " + page);
                        ...
                        String menuOptions = "Selecionar uma pergunta (1-"+(lastIndex%11)+")\nou 0 para voltar";

                        if(hasNext) menuOptions = "\">\" para avançar a página\n".concat(menuOptions);
                        if(hasPrev) menuOptions = "Voltar página com \"<\" ou ".concat(menuOptions);
    ...
    private void search(String keywords) throws Exception {
        ...
        do {
            List<Integer> matchingPerguntas = perguntaService.list(keywords);
